...
IF !(aCabPed[1]$"DB")		//C5_TIPO
   ...
   nPrinLin := nInicio
	...
	nPrinLin += 30
	oReport:PrintText(IF( !Empty(SA1->A1_ENDENT) .And. SA1->A1_ENDENT # SA1->A1_END,ALLTRIM(SA1->A1_ENDENT)+" "+;
			SA1->A1_COMPLEM, ALLTRIM(SA1->A1_END)+" "+SA1->A1_COMPLEM ),nPrinLin,760)
	nPrinLin += 30
