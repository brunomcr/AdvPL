...
TRCell():New(oSection1,'cLote'		,'SC2',"Lote"			,/*Picture*/					,20						,/*lPixel*/,{|| "__________________" })
//TRCell():New(oSection1,'dDtValid'	,'SC2',"Validade"		,/*Picture*/					,9						,/*lPixel*/,{|| " __/__/__ " })
TRCell():New(oSection1,'RealIni'	,'SC2',STR0044   		,/*Picture*/                 	,9						,/*lPixel*/,{|| " __/__/__ " })
TRCell():New(oSection1,'RealFim'	,'SC2',STR0045   		,/*Picture*/                 	,9						,/*lPixel*/,{|| " __/__/__ " })
TRCell():New(oSection1,'HoraIni'	,'SC2','Hora Inicial'   ,/*Picture*/                 	,9						,/*lPixel*/,{|| " __:__:__ " })
TRCell():New(oSection1,'HoraFim'	,'SC2','Hora Final'		,/*Picture*/                 	,9						,/*lPixel*/,{|| " __:__:__ " })
TRCell():New(oSection1,'C2_zz'		,'SC2','Obs.'			,/*Picture*/					,TamSX3('C2_OBS')[1] 			,/*lPixel*/,{|| " __________________________ " })
...
oSection1:Cell('cLote' ):SetCellBreak()
oSection1:Cell('RealFim'  ):SetCellBreak()
oSection1:Cell('HoraFim'  ):SetCellBreak()
oSection1:Cell('C2_zz'  ):SetCellBreak()
